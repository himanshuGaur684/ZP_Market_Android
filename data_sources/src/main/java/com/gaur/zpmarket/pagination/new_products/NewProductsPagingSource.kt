...
class NewProductsPagingSource(private val dataSourcesInterface: DataSourcesInterface) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Product> {
        return try {
            ...
            val response = SafeApiRequest.handleApiCall<NewestProductPagingResponse> {
                dataSourcesInterface.getNewestProducts(
                    position,
                    10
                )
            }
