...
class RecentlyViewedAdapter() : RecyclerView.Adapter<RecentlyViewedAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): RecentlyViewedAdapter.MyViewHolder {
        val binding =
            ViewHolderRecentlyViewedBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return MyViewHolder(binding)
    }

    override fun onBindViewHolder(holder: RecentlyViewedAdapter.MyViewHolder, position: Int) {
